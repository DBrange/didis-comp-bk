...
type ForManagingCategory interface {
	...
	GetCompetitorsOfCategoryByName(ctx context.Context, categoryOID string, name string, sport models.SPORT, competitorType models.COMPETITOR_TYPE) ([]*category_registration_dao.GetCompetitorsOfCategoryCompetitorDAORes, error)
	...
	GetParticipantsOfCategory(ctx context.Context, categoryID string, sport models.SPORT, competitorType models.COMPETITOR_TYPE, limit int, lastID string) ([]*category_registration_dao.GetCompetitorsOfCategoryCompetitorDAORes, error)
	...
	DeleteCategoryRegistration(ctx context.Context, categoryOID, competitorOID *primitive.ObjectID) error
...
GetTournamentsByNameFromCategory(ctx context.Context, categoryID string, sport models.SPORT, competitorType models.COMPETITOR_TYPE, tournamentName string) ([]*category_dao.GetTournamentsFromCategoryDAORes, error)
}
